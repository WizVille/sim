...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_HELICONE_SA:  z.string().optional(),
    NEXT_PUBLIC_GOOGLE_BASE_URL:  z.string().optional(),
    NEXT_PUBLIC_HELICONE_BASE_URL:  z.string().optional(),
    NEXT_PUBLIC_VTX_SA:  z.string().optional()
  },
